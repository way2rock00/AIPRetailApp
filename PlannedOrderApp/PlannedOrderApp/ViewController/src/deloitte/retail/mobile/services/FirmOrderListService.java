...
public class FirmOrderListService {
    ...
    public FirmOrder[] getFirmOrderList()
    {
        ...
        AdfmfJavaUtilities.setELValue("#{pageFlowScope.SellableUpc}", "400000003078");
        AdfmfJavaUtilities.setELValue("#{pageFlowScope.StoreName}", "Toronto");
        AdfmfJavaUtilities.setELValue("#{pageFlowScope.ProductDesc}", "Description for product 400000003078");
        
        String strSellableUpc = (String)AdfmfJavaUtilities.getELValue("#{pageFlowScope.SellableUpc}");
